...
const VideoCard = ( { video: { title, thumbnail, video, creator: { username, avatar } } } ) => {
    ...
    return (
        <View className="flex-col items-center px-4 mb-14" >
            <View className="flex-row gap-0 items-start" >
                ...
                <View className="pt-2" >
                    <Image source={ icon.menu } resizeMode='contain' className="w-5 h-5" />
                </View>
            </View>
            {
                play ? (
                    ...
                    >
                        ...
                        <Image source={ icon.play } className="w-12 h-12 absolute" resizeMode='contain' />
                    </TouchableOpacity>
                )
            }
        </View>
